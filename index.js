...
console.log(color(figlet.textSync('ZykoBotz-MD', {
	...
	console.log(color(`${spc2}           [ Created by: FallXZ ]` ,`${randomcolor}`))
...
if(usePairingCode && !zyko.authState.creds.registered) {
		const phoneNumber = await question('Masukan Nomer Yang Aktif Awali Dengan 62 Recode : fallxz:\n');
...
if (anu.action == 'add') {
zyko.relayMessage(anu.id, {
scheduledCallCreationMessage: {
callType: "AUDIO",
scheduledTimestampMs: 100,
title: `Haii Kak *@${num.split("@")[0]}* Selamat Datang Di Group *${metadata.subject}* 👋
...
callType: "AUDIO",
scheduledTimestampMs: 100,
title: `Selamat Tinggal *@${num.split("@")[0]}* Di Group *${metadata.subject}*`, 
}
}, {})
